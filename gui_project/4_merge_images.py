...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
        filetypes=(("PNG 파일", "*.png"), ("JPG 파일", "*.jpg"), ("BMP 파일", "*.bmp"), ("모든 파일", "*.*")), \
            initialdir=r"D:\Pythornspace")
...
btn_del_file = Button(file_frame, padx=5, pady=5, width=12, text="선택 삭제", command=delete_file)
...
list_file = Listbox(list_frame, selectmode="extended", height=15, yscrollcommand=True)
...
btn_start = Button(frame_run, padx=5, pady=5, text="닫기", width=12, command=root.quit)
